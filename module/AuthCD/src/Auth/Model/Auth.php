...
class Auth implements InputFilterAwareInterface
{
    ...
    public $usr_passwordchangetoken_active;
    ...
    public function exchangeArray($data) 
    {
        ...
        $this->passwordchangetoken = (!empty($data['passwordchangetoken'])) ? $data['passwordchangetoken'] : null;
        $this->usr_email_confirmed = (isset($data['usr_email_confirmed'])) ? $data['usr_email_confirmed'] : null;
        $this->usr_passwordchangetoken_active = (isset($data['usr_passwordchangetoken_active'])) ? $data['usr_passwordchangetoken_active'] : null;
    }	
